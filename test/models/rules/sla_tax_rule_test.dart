...
void main() {
  ...
  late IndustrialProduct otherProduct;
  ...
  setUp(() {
    ...
    otherProduct = IndustrialProduct(
        id: "",
  ...
  void setSlaAttribute(int value){
    corporateProduct.setAttribute<int>(AttributeKeys.corporate.sla, value);
  }

  group("evaluate", () {
    test("should return false when product is not a CorporateProduct", () {
      final cart = CartModel(product: otherProduct, quantity: 1).obs;
    ...
    test("should throw Exception when product is a CorporateProduct but SLA attribute is missing", () {
      corporateProduct.attributes.clear();
      final cart = CartModel(product: corporateProduct, quantity: 1).obs;
      final call = sut.evaluate;
      expect(() => call(cart), throwsA(isA<Exception>()));
    });
  });
  ...
  group("execute", () {
    test("should apply a 20% tax to the total price and set additional charge message", () {
      ...
      final cart = CartModel(
          product: corporateProduct, quantity: 1, totalPrice: 100.0
      ).obs;
